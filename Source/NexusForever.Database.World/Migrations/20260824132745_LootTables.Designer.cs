...
namespace NexusForever.Database.World.Migrations
{
    ...
    [Migration("20260824132745_LootTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexusForever.Database.World.Model.CreatureLootModel", b =>
                {
                    ...
                    b.Property<uint>("LootTableId")
                        .HasColumnType("int(10) unsigned")
                        .HasColumnName("lootTableId");

                    b.HasKey("CreatureId", "LootTableId")
                        .HasName("PRIMARY");
            ...
            modelBuilder.Entity("NexusForever.Database.World.Model.LootTableEntryModel", b =>
                {
                    b.Property<uint>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(10) unsigned")
                    ...
                    b.Property<uint?>("ObservedAttempts")
                        .HasColumnType("int(10) unsigned")
                        .HasColumnName("observedAttempts");

                    b.Property<uint?>("ObservedDrops")
                        .HasColumnType("int(10) unsigned")
                    ...
                    b.ToTable("loot_table_entry", null, t =>
                        {
                            t.HasCheckConstraint("CK_loot_table_entry_amount", "`minAmount` > 0 AND `maxAmount` >= `minAmount`");

                            t.HasCheckConstraint("CK_loot_table_entry_chance", "`chance` <= 1000000");
                        });
                });

            modelBuilder.Entity("NexusForever.Database.World.Model.LootTableModel", b =>
                {
                    b.Property<uint>("Id")
                        .HasColumnType("int(10) unsigned")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("NexusForever.Database.World.Model.CreatureLootModel", b =>
                {
                    b.HasOne("NexusForever.Database.World.Model.LootTableModel", "LootTable")
                        .WithMany("CreatureLoot")
